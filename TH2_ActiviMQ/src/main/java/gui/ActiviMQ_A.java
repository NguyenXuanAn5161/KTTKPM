...
public class ActiviMQ_A implements ActionListener, MouseListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActiviMQ_A window = new ActiviMQ_A();
	 ...
	 */
	public ActiviMQ_A() throws Exception {
		initialize();
//		cấu hình môi trường cho JMS và JNDI -> tạo 1 kết nối đến ActiviMQ
		...
		destinationA = (Destination) ctx.lookup("dynamicQueues/NguyenXuanAn");
		destinationB = (Destination) ctx.lookup("dynamicQueues/TranTruongThien");
...
//		MessageConsumer receiverA = session.createConsumer(destinationA);
//		// blocked-method for receiving message - sync
//		// receiver.receive();
//		// Cho receiver lắng nghe trên queue, chừng có message thì notify - async
//		System.out.println("Tý was listened on queue...");
//		receiverA.setMessageListener(new MessageListener() {
////			@Override
//			// có message đến queue, phương thức này được thực thi
//			public void onMessage(Message msg) {// msg là message nhận được
//				try {
...
//		});
	...
	private void initialize() {
		...
		JLabel lbl_title = new JLabel("ActiviMQ A");
